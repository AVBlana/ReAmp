...
export interface UnifiedPlaylistItemProps {
  item: YoutubeVideo | Song;
  service: ServiceType;
}

const UnifiedPlaylistItem = memo(
  ({ item, service }: UnifiedPlaylistItemProps) => {
...
UnifiedPlaylistItem.displayName = "UnifiedPlaylistItem";

export { UnifiedPlaylistItem };
