...
describe("Search Dropdown Clearing - Critical Fix", () => {
  ...
  it("should clear search input, results, and close dropdown on outside click", async () => {
    // Mock search results
  ...
  it("should clear search input, results, and close dropdown on escape key", async () => {
    // Mock search results
    mockUnifiedContext.youtube.searchResults = [
      {
        id: { videoId: "123" },
    ...
    // Verify console log
    expect(console.log).toHaveBeenCalledWith(
      "🔍 Search dropdown: Escape key - clearing all state"
    );
  });
