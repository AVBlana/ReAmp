...
export default function DJPlayerB({
  playerState,
  onStateChange,
  onClear,
  isActive,
  ...
  useEffect(() => {
    ...
    const player = new window.YT.Player(containerRef.current, {
      ...
      events: {
        onReady: (event: any) => {
          console.log("Player B YouTube ready");
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-bold text-[#4ECDC4]">Player B</h3>
      ...
      <div className="flex-1 relative min-h-0">
        <Droppable droppableId="dj-player-B">
          {(provided, snapshot) => (
            <div
